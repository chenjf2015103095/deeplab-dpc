...
def _classifier(src_dir, dst_dir, classes):
    ...
    for root, dirs, files in os.walk(src_dir):
        for json_file in files:
            ...
            total += 1
            try:
                print(os.path.join(src_dir, json_file))
                with open(os.path.join(src_dir, json_file), 'r') as load_f:
                    load_dict = json.load(load_f)
                    shapes = load_dict['shapes']
                    imagePath = load_dict['imagePath']
...
if __name__ == '__main__':
    ...
    xml = 0
    js = 0
    # src_dir='/home/ubutnu/a_data_train/data_13/2019-03-11-banghao-whole-demage-9/image'
    # src_dir='/home/ubutnu/work/dataArea/data/2019-1-17-whole'
    # src_dir='/home/ubutnu/work/dataArea/data/2019-03-11-banghao-whole-demage-9'
    # for root, dirs, files in os.walk(src_dir):
    #     for f in files:
    ...
    # dst_dir = '/media/ubutnu/fc1a3be7-9b03-427e-9cc9-c4b242cefbff/data/banghao'
    # import shutil
    # for root, dirs, files in os.walk(src_dir):
    #     for f in files:
    #         if f.endswith('.jpg') or f.endswith('.JPG'):
    ...
    #         if f.endswith('.json'):
    #             js += 1
    # print('total='+str(total)+' ,jpg='+str(num))
    # print('xml=' + str(xml) + ' ,json=' + str(js))

    # src_dir='/media/ubutnu/fc1a3be7-9b03-427e-9cc9-c4b242cefbff/data/banghao'
    # dst_dir='/media/ubutnu/fc1a3be7-9b03-427e-9cc9-c4b242cefbff/cjf_data/damage_part'
    ...
    # src_dir = '/home/ubutnu/work/dataArea/cjf_data/damage_part'
    # output_classes_txt = '/home/ubutnu/work/dataArea/cjf_data/damage.txt'
    # generate_classes_txt(src_dir=src_dir, output_classes_txt=output_classes_txt)
    # dst_dir = '/home/ubutnu/work/dataArea/cjf_data/damage'
    #split_train_val_data(src_dir=src_dir, dst_dir=dst_dir, output_classes_txt=output_classes_txt, radio=10)

    ########################################################################
    ########################################################################
    ########################################################################
    #测试官方数据集
    src_dir= '/home/ubutnu/a_data_train/VOC2012/main'
    output_classes_txt= '/home/ubutnu/a_data_train/VOC2012/main_txt'
    # generate_classes_txt(src_dir=src_dir,output_classes_txt=output_classes_txt)
    dst_dir= '/home/ubutnu/a_data_train/VOC2012/main_part'
    split_train_val_data(src_dir=src_dir,dst_dir=dst_dir,output_classes_txt=output_classes_txt)