...
class InferSegment(object):
    ...
    def infer(self, image_path):
        if self.class_names is None:
            with open(self.label_file_path, 'b') as load_f:
...
if __name__ == '__main__':
    class_names_file = '/home/ubutnu/a_data_train/tf_deeplab/my_models/deeplabv3_dpc_cityscapes_trainfine/damage/class_names.txt'
    pb_model_path = '/home/ubutnu/a_data_train/tf_deeplab/my_models/deeplabv3_dpc_cityscapes_trainfine/damage/export/1010/frozen_inference_graph.pb'
    ...
    image_path1 = '/home/ubutnu/a_data_train/VOC2012/2007_000027.jpg'
